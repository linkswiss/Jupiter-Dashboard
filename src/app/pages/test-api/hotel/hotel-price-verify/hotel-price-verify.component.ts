...
export class HotelPriceVerifyComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.jupiterHotelPriceVerifyRq = this.hotelPagesService.initJupiterHotelPriceVerifyRQ();
    this.jupiterHotelPriceVerifyRs = this.hotelPagesService.initJupiterHotelPriceVerifyRS();
  }
